...
- `USERS.guru_id` bersifat opsional — hanya terisi untuk role yang terhubung ke data guru (Wakil Kurikulum, Kepala Sekolah bila dijabat guru, Guru Mapel/Wali Kelas, Guru BK).
