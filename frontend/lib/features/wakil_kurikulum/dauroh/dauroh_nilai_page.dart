...
class DaurohNilaiPage extends StatefulWidget {
  const DaurohNilaiPage({super.key});

  @override
  State<DaurohNilaiPage> createState() => _DaurohNilaiPageState();
}

class _DaurohNilaiPageState extends State<DaurohNilaiPage> {
  ...
  Future<void> _loadFilters() async {
    try {
      final res = await WakilKurikulumService.getDaurohFilters();
      if (mounted) {
        setState(() {
