  ...
  Widget _currentPage() {
    if (_activeFeature != null) {
      switch (_activeFeature) {
        case 'absensi': return const AbsensiPageWK();
        case 'penjadwalan': return const PenjadwalanPage();
        case 'nilai': return const NilaiPageWK();
        case 'kenaikan-kelas': return const KenaikanKelasPage();
        case 'laporan': return const LaporanPageWK();
        default: return DashboardPageWK(onFeatureTap: _openFeature, onLogout: _logout);
      }
    }
    switch (_shellTab) {
        ...
        NavigationRail(
          ...
          leading: Padding(
            ...
            child: Row(children: [
              ...
              const Text('WK', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
            ]),
          ),
          trailing: Padding(
            padding: const EdgeInsets.all(8),
