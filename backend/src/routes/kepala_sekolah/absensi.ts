...
export async function handleAbsensiKS(request: Request, env: Env, url: URL): Promise<Response> {
  ...
  const subPath = url.pathname.replace('/api/kepala-sekolah/absensi', '');

  // GET /api/kepala-sekolah/absensi/guru - monitoring absensi guru
  ...
  // GET /api/kepala-sekolah/absensi/siswa - monitoring absensi siswa
