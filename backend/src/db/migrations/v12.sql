-- ============================================================
-- MIGRATION v12 — kelas gabungan (combined classes)
...
--
-- CARA PAKAI:
--   1. Backup dulu! (wrangler d1 export ppi-db-prod --remote)
--   2. Jalankan via wrangler:
--      wrangler d1 execute ppi-db-prod --remote --file=./src/db/migrations/v12.sql
