...
-- ============================================
-- File: seed_dauroh_surat.sql
-- Untuk: Tabel dauroh_surat
-- Tanggal: 10 Agustus 2026

-- Pastikan tabel dauroh_surat sudah ada sebelum menjalankan seed ini

INSERT INTO dauroh_surat (nomor, nama, nama_arab, jumlah_ayat, juz, type) VALUES
-- Juz 1
(1, 'Al-Fatihah', 'الفاتحة', 7, 1, 'makkiyah'),
(2, 'Al-Baqarah', 'البقرة', 286, 1, 'madaniyah'),

-- Juz 2-3 (Al-Baqarah lanjutan)
-- Al-Baqarah sudah diinsert di atas (nomor 2)
